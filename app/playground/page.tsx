...
export default function PlaygroundPage() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      {/* 主内容区域 - 自适应高度 */}
      <main className="flex-1 bg-[#0B1121] flex flex-col pt-14">
        {/* 内容容器 */}
        <div className="flex-1 w-full max-w-[1680px] mx-auto px-6 py-6">
          {/* 编辑器和输出面板区域 */}
          <div className="h-[calc(100vh-theme(spacing.14)-theme(spacing.6)*2)] flex items-stretch gap-4">
            {/* 编辑器区域 */}
            <motion.div
